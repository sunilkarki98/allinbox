...
export const DEMO_CUSTOMERS: Customer[] = [
    ...
    // TikTok users removed for Phase 1
    {
        id: 'cust-3',
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-0.5">
                                                <span className={`inline-flex items-center gap-1 text-xs font-medium ${customer.platform === 'INSTAGRAM' ? 'text-pink-600' : 'text-slate-600'}`}>
                                                    <PlatformIcon platform={customer.platform} className="w-3.5 h-3.5" />
                                                    {customer.platform === 'INSTAGRAM' ? 'IG' : 'TT'}
                                                </span>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <div className={`p-1.5 rounded-full ${customer.platform === 'INSTAGRAM' ? 'bg-pink-100 text-pink-600' :
                                                            customer.platform === 'FACEBOOK' ? 'bg-blue-100 text-blue-600' :
                                                                customer.platform === 'TIKTOK' ? 'bg-slate-100 text-slate-800' :
