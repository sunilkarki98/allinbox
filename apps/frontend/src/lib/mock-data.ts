...
export interface Interaction extends Partial<DBInteraction> {
    ...
    isReplied: boolean;
    postUrl?: string;
    postPlatform?: 'TIKTOK' | 'INSTAGRAM' | 'WHATSAPP' | 'FACEBOOK' // NEW;
    ...
    // Lead Context (Joined from customers table - Unified Profile)
    leadScore?: number;
    leadName?: string; // NEW: Display name from customers table
    ...
    sourcePostId?: string;
    sourceChannel?: 'INSTAGRAM' | 'FACEBOOK' | 'WHATSAPP' | 'TIKTOK';
